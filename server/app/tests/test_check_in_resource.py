...
from constants import CHECK_IN, CHECK_OUT, MSG_TASK_ID_REQUIRED, MSG_TASK_ID_DOES_NOT_EXIST, MSG_TASK_ALREADY_CHECKED_IN, MSG_USER_ALREADY_CHECKED_IN, MSG_TASK_CHECKED_IN_SUCCESSFULLY
...
class CheckInResourceTestCase(BaseTestCase):
    ...
    def test_checkin_success(self):
        with self.app.app_context():
            ...
            self.assertEqual(response.get_json()['message'], MSG_TASK_CHECKED_IN_SUCCESSFULLY.format(task.name))
