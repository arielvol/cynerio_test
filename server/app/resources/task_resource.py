...
from constants import MSG_USER_NOT_FOUND, MSG_TASK_ALREADY_EXISTS, MSG_TASK_WAS_CREATED_SUCCESSFULLY, MSG_TASK_NAME_REQUIRED, MSG_USER_ID_REQUIRED
...
class TaskResource(Resource):
    ...
    def post(self):
        ...
        return {'message': MSG_TASK_WAS_CREATED_SUCCESSFULLY.format(task_name)}, 201
