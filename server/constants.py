...
MSG_TASK_CHECKED_IN_SUCCESSFULLY = "Task {} was successfully checked in."
...
MSG_TASK_CHECKED_OUT_SUCCESSFULLY = "Task {} was successfully checked out."
MSG_NO_TASKS_TO_REPORT = "No tasks to report."
MSG_USER_NOT_FOUND = "User with id {} was not found."
MSG_TASK_ALREADY_EXISTS = "Task {} already exists."
MSG_TASK_WAS_CREATED_SUCCESSFULLY = "Task '{}' was created successfully."
MSG_USER_ALREADY_CHECKED_IN = "User is already checked in to task: {}"
MSG_USER_WAS_CREATED_SUCCESSFULLY = "User '{}' was created successfully."
